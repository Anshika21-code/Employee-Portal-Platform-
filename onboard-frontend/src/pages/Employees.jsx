        ...
        {tasks.map(task => {
          ...
          return (
            <div
              key={task.id}
              className={`
                flex items-center justify-between gap-3 p-2.5 rounded-xl text-sm
            ...
            >
              ...
              {/* ✅ Status dropdown — HR changes it here */}
              <select
                value={task.status}
                disabled={isUpdating}
...
export default function Employees() {
  ...
  // ── Called by TaskPanel after a status update ──
  //    Updates the employee card's progress bar and AI badge WITHOUT page reload
